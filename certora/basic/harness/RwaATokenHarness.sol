...
import {RwaATokenInstance} from '../munged/contracts/instances/RwaATokenInstance.sol';
 ...
 */
contract RwaATokenHarness is RwaATokenInstance {
  using WadRayMath for uint256;

  constructor(Pool pool) public RwaATokenInstance(pool) {}
