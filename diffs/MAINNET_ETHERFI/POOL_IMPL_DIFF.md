```diff
diff --git a/./downloads/MAINNET/POOL_IMPL.sol b/./downloads/ETHERFI/POOL_IMPL.sol
index 16f8d61..905b083 100644
--- a/./downloads/MAINNET/POOL_IMPL.sol
+++ b/./downloads/ETHERFI/POOL_IMPL.sol
@@ -1,194 +1,7 @@
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IAaveIncentivesController.sol
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPoolAddressesProvider.sol
 
 /**
  * @title IPoolAddressesProvider
@@ -1099,7 +912,7 @@ interface IPoolAddressesProvider {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPriceOracleGetter.sol
 
 /**
  * @title IPriceOracleGetter
@@ -1129,7 +942,7 @@ interface IPriceOracleGetter {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IScaledBalanceToken.sol
 
 /**
  * @title IScaledBalanceToken
@@ -1201,7 +1014,7 @@ interface IScaledBalanceToken {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
 
 /**
  * @title VersionedInitializable
@@ -1278,7 +1091,7 @@ abstract contract VersionedInitializable {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/helpers/Errors.sol
 
 /**
  * @title Errors library
@@ -1386,7 +1199,7 @@ library Errors {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/PercentageMath.sol
 
 /**
  * @title PercentageMath library
@@ -1447,7 +1260,7 @@ library PercentageMath {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/WadRayMath.sol
 
 /**
  * @title WadRayMath library
@@ -1573,7 +1386,7 @@ library WadRayMath {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/types/DataTypes.sol
 
 library DataTypes {
   /**
@@ -1886,7 +1699,7 @@ library DataTypes {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
 
 /// @title Gnosis Protocol v2 Safe ERC20 Transfer Library
 /// @author Gnosis Developers
@@ -1999,7 +1812,7 @@ library GPv2SafeERC20 {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
 
 interface IERC20Detailed is IERC20 {
   function name() external view returns (string memory);
@@ -2009,7 +1822,7 @@ interface IERC20Detailed is IERC20 {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IACLManager.sol
 
 /**
  * @title IACLManager
@@ -2182,7 +1995,7 @@ interface IACLManager {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IERC20WithPermit.sol
 
 /**
  * @title IERC20WithPermit
@@ -2213,7 +2026,7 @@ interface IERC20WithPermit is IERC20 {
   ) external;
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPriceOracleSentinel.sol
 
 /**
  * @title IPriceOracleSentinel
@@ -2278,7 +2091,7 @@ interface IPriceOracleSentinel {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
 
 /**
  * @title IReserveInterestRateStrategy
@@ -2306,7 +2119,7 @@ interface IReserveInterestRateStrategy {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/MathUtils.sol
 
 /**
  * @title MathUtils library
@@ -2403,39 +2216,7 @@ library MathUtils {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPool.sol
 
 /**
  * @title IPool
@@ -3234,40 +3015,40 @@ interface IPool {
   /**
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
 
 /**
  * @title ReserveConfiguration library
@@ -3904,7 +3685,7 @@ library ReserveConfiguration {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/helpers/Helpers.sol
 
 /**
  * @title Helpers library
@@ -3929,7 +3710,7 @@ library Helpers {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanReceiver.sol
 
 /**
  * @title IFlashLoanReceiver
@@ -3962,7 +3743,7 @@ interface IFlashLoanReceiver {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol
 
 /**
  * @title IFlashLoanSimpleReceiver
@@ -3995,7 +3776,7 @@ interface IFlashLoanSimpleReceiver {
   function POOL() external view returns (IPool);
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
 
 /**
  * @title UserConfiguration library
@@ -4227,750 +4008,7 @@ library UserConfiguration {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IInitializableAToken.sol
 
 /**
  * @title IInitializableAToken
@@ -5023,7 +4061,7 @@ interface IInitializableAToken {
   ) external;
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IInitializableDebtToken.sol
 
 /**
  * @title IInitializableDebtToken
@@ -5072,7 +4110,7 @@ interface IInitializableDebtToken {
   ) external;
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IStableDebtToken.sol
 
 /**
  * @title IStableDebtToken
@@ -5209,7 +4247,7 @@ interface IStableDebtToken is IInitializableDebtToken {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
 
 /**
  * @title IsolationModeLogic library
@@ -5268,7 +4306,7 @@ library IsolationModeLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IVariableDebtToken.sol
 
 /**
  * @title IVariableDebtToken
@@ -5311,7 +4349,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IAToken.sol
 
 /**
  * @title IAToken
@@ -5445,7 +4483,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
 
 /**
  * @title IncentivizedERC20
@@ -5669,7 +4707,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -6029,7 +5067,7 @@ library ReserveLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/pool/PoolStorage.sol
 
 /**
  * @title PoolStorage
@@ -6075,7 +5113,7 @@ contract PoolStorage {
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
 
 /**
  * @title EModeLogic library
@@ -6176,7 +5214,7 @@ library EModeLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
 
 /**
  * @title GenericLogic library
@@ -6434,7 +5472,7 @@ library GenericLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -7194,7 +6232,7 @@ library ValidationLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol
 
 library BridgeLogic {
   using ReserveLogic for DataTypes.ReserveCache;
@@ -7331,7 +6369,7 @@ library BridgeLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/PoolLogic.sol
 
 /**
  * @title PoolLogic library
@@ -7521,7 +6559,7 @@ library PoolLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/SupplyLogic.sol
 
 /**
  * @title SupplyLogic library
@@ -7809,7 +6847,7 @@ library SupplyLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/BorrowLogic.sol
 
 /**
  * @title BorrowLogic library
@@ -8153,7 +7191,7 @@ library BorrowLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol
 
 /**
  * @title LiquidationLogic library
@@ -8663,7 +7701,7 @@ library LiquidationLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol
 
 /**
  * @title FlashLoanLogic library
@@ -8929,7 +7967,7 @@ library FlashLoanLogic {
   }
 }
...
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/contracts/protocol/pool/Pool.sol
 
 /**
  * @title Pool contract
@@ -9759,7 +8797,7 @@ abstract contract Pool is VersionedInitializable, PoolStorage, IPool {
   }
 }
 
-// downloads/MAINNET/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/instances/PoolInstance.sol
+// downloads/ETHERFI/POOL_IMPL/PoolInstance/src/core/instances/PoolInstance.sol
 
 contract PoolInstance is Pool {
   uint256 public constant POOL_REVISION = 4;
@@ -9782,71 +8820,3 @@ contract PoolInstance is Pool {
