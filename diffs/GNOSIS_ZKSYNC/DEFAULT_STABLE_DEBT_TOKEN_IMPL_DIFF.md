```diff
diff --git a/./downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL.sol b/./downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL.sol
index 4998b88..beebf3b 100644
--- a/./downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL.sol
+++ b/./downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL.sol
@@ -1,7 +1,7 @@
 // SPDX-License-Identifier: MIT
 pragma solidity ^0.8.0 ^0.8.10;
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IAaveIncentivesController.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/ICreditDelegationToken.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IPoolAddressesProvider.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/libraries/helpers/Errors.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/libraries/math/WadRayMath.sol
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/libraries/types/DataTypes.sol
...
@@ -1015,13 +1064,14 @@ library DataTypes {
...
@@ -1156,6 +1206,7 @@ library DataTypes {
...
@@ -1220,7 +1271,8 @@ library DataTypes {
...
@@ -1234,7 +1286,7 @@ library DataTypes {
   }
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/tokenization/base/EIP712Base.sol
+// downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtTokenInstance/src/core/contracts/protocol/tokenization/base/EIP712Base.sol
 ...
 /**
  * @title EIP712Base
@@ -1304,7 +1356,7 @@ abstract contract EIP712Base {
   function _EIP712BaseId() internal view virtual returns (string memory);
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
...
@@ -1314,7 +1366,7 @@ interface IERC20Detailed is IERC20 {
   function decimals() external view returns (uint8);
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IACLManager.sol
+// downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtTokenInstance/src/core/contracts/interfaces/IACLManager.sol
 
 /**
  * @title IACLManager
@@ -1487,104 +1539,7 @@ interface IACLManager {
   function isAssetListingAdmin(address admin) external view returns (bool);
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/libraries/math/MathUtils.sol
-
-/**
...
-}
-
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IPool.sol
+// downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtTokenInstance/src/core/contracts/interfaces/IPool.sol
 
 /**
  * @title IPool
@@ -1962,6 +1917,14 @@ interface IPool {
    */
...
@@ -2106,6 +2069,22 @@ interface IPool {
...
+
    ...
    * @dev Only callable by the PoolConfigurator contract
@@ -2161,7 +2140,23 @@ interface IPool {
    * @param asset The address of the underlying asset of the reserve
...
@@ -2189,6 +2184,13 @@ interface IPool {
    */
...
@@ -2259,6 +2261,22 @@ interface IPool {
    */
...
@@ -2316,9 +2334,44 @@ interface IPool {
...
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IInitializableDebtToken.sol
...
@@ -2367,7 +2420,7 @@ interface IInitializableDebtToken {
   ) external;
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/interfaces/IStableDebtToken.sol
...
@@ -2504,7 +2557,7 @@ interface IStableDebtToken is IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/tokenization/base/DebtTokenBase.sol
+// downloads/ZKSYNC/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtTokenInstance/src/core/contracts/protocol/tokenization/base/DebtTokenBase.sol
 ...
 /**
  * @title DebtTokenBase
@@ -2600,7 +2653,7 @@ abstract contract DebtTokenBase is
   }
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
...
@@ -2655,15 +2708,15 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   /**
    * @dev Constructor.
...
@@ -2824,7 +2877,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   }
 }
 
-// downloads/GNOSIS/DEFAULT_STABLE_DEBT_TOKEN_IMPL/StableDebtToken/src/core/contracts/protocol/tokenization/StableDebtToken.sol
...
@@ -2833,20 +2886,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
  * at stable rate mode
...
@@ -2857,6 +2897,128 @@ contract StableDebtToken is DebtTokenBase, IncentivizedERC20, IStableDebtToken {
...
+
   ...
   function initialize(
     IPool initializingPool,
@@ -2887,313 +3049,4 @@ contract StableDebtToken is DebtTokenBase, IncentivizedERC20, IStableDebtToken {
       params
     );
   }
-
