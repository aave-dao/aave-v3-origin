...
index 3f69074..46512b1 100644
--- a/./downloads/GNOSIS/POOL_IMPL.sol
+++ b/./downloads/ZKSYNC/POOL_IMPL.sol
@@ -1,421 +1,7 @@
 // SPDX-License-Identifier: MIT
-pragma solidity >=0.6.0 ^0.8.0 ^0.8.10;
+pragma solidity ^0.8.0 ^0.8.10;
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/lib/aave-v3-core/contracts/interfaces/IPoolAddressesProvider.sol
-
-/**
...
-}
-
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/common/ICollector.sol
-
-/**
- * @title ICollector
...
-}
-
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
 
 // OpenZeppelin Contracts v4.4.1 (utils/Address.sol)
 
@@ -635,7 +221,7 @@ library Address {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
 
 /*
  * @dev Provides information about the current execution context, including the
@@ -658,7 +244,7 @@ abstract contract Context {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
 
 /**
  * @dev External interface of AccessControl declared to support ERC165 detection.
@@ -748,7 +334,7 @@ interface IAccessControl {
   function renounceRole(bytes32 role, address account) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
 
 /**
  * @dev Interface of the ERC20 standard as defined in the EIP.
@@ -824,7 +410,7 @@ interface IERC20 {
   event Approval(address indexed owner, address indexed spender, uint256 value);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
 
 // OpenZeppelin Contracts v4.4.1 (utils/math/SafeCast.sol)
 
@@ -1080,7 +666,7 @@ library SafeCast {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IAaveIncentivesController.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IAaveIncentivesController.sol
 
 /**
  * @title IAaveIncentivesController
@@ -1099,7 +685,7 @@ interface IAaveIncentivesController {
   function handleAction(address user, uint256 totalSupply, uint256 userBalance) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPoolAddressesProvider.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPoolAddressesProvider.sol
 
 /**
  * @title IPoolAddressesProvider
@@ -1326,7 +912,7 @@ interface IPoolAddressesProvider {
   function setPoolDataProvider(address newDataProvider) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPriceOracleGetter.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPriceOracleGetter.sol
 
 /**
  * @title IPriceOracleGetter
@@ -1356,7 +942,7 @@ interface IPriceOracleGetter {
   function getAssetPrice(address asset) external view returns (uint256);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IScaledBalanceToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IScaledBalanceToken.sol
 
 /**
  * @title IScaledBalanceToken
@@ -1428,7 +1014,7 @@ interface IScaledBalanceToken {
   function getPreviousIndex(address user) external view returns (uint256);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
 
 /**
  * @title VersionedInitializable
@@ -1505,7 +1091,7 @@ abstract contract VersionedInitializable {
   uint256[50] private ______gap;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/helpers/Errors.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/helpers/Errors.sol
 
 /**
  * @title Errors library
@@ -1613,7 +1199,7 @@ library Errors {
   string public constant INVALID_FREEZE_STATE = '99'; // Reserve is already in the passed freeze state
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/PercentageMath.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/PercentageMath.sol
 
 /**
  * @title PercentageMath library
@@ -1674,7 +1260,7 @@ library PercentageMath {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/WadRayMath.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/WadRayMath.sol
 
 /**
  * @title WadRayMath library
@@ -1800,7 +1386,7 @@ library WadRayMath {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/types/DataTypes.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/types/DataTypes.sol
 
 library DataTypes {
   /**
@@ -2113,180 +1699,7 @@ library DataTypes {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/lib/aave-v3-core/contracts/interfaces/IACLManager.sol
-
-/**
- * @title IACLManager
- * @author Aave
...
-}
-
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
 
 /// @title Gnosis Protocol v2 Safe ERC20 Transfer Library
 /// @author Gnosis Developers
@@ -2399,7 +1812,7 @@ library GPv2SafeERC20 {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
 
 interface IERC20Detailed is IERC20 {
   function name() external view returns (string memory);
@@ -2409,7 +1822,7 @@ interface IERC20Detailed is IERC20 {
   function decimals() external view returns (uint8);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IACLManager.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IACLManager.sol
 
 /**
  * @title IACLManager
@@ -2582,7 +1995,7 @@ interface IACLManager {
   function isAssetListingAdmin(address admin) external view returns (bool);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IERC20WithPermit.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IERC20WithPermit.sol
 
 /**
  * @title IERC20WithPermit
@@ -2613,7 +2026,7 @@ interface IERC20WithPermit is IERC20 {
   ) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPriceOracleSentinel.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IPriceOracleSentinel.sol
 
 /**
  * @title IPriceOracleSentinel
@@ -2678,7 +2091,7 @@ interface IPriceOracleSentinel {
   function getGracePeriod() external view returns (uint256);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
 
 /**
  * @title IReserveInterestRateStrategy
@@ -2706,7 +2119,7 @@ interface IReserveInterestRateStrategy {
   ) external view returns (uint256, uint256, uint256);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/MathUtils.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/math/MathUtils.sol
 
 /**
  * @title MathUtils library
@@ -2803,39 +2216,7 @@ library MathUtils {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/AaveV3.sol
-
...
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
 
 /**
  * @title ReserveConfiguration library
@@ -4304,7 +3685,7 @@ library ReserveConfiguration {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/helpers/Helpers.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/helpers/Helpers.sol
 
 /**
  * @title Helpers library
@@ -4329,7 +3710,7 @@ library Helpers {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/flashloan/interfaces/IFlashLoanReceiver.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanReceiver.sol
 
 /**
  * @title IFlashLoanReceiver
@@ -4362,7 +3743,7 @@ interface IFlashLoanReceiver {
   function POOL() external view returns (IPool);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol
 
 /**
  * @title IFlashLoanSimpleReceiver
@@ -4395,7 +3776,7 @@ interface IFlashLoanSimpleReceiver {
   function POOL() external view returns (IPool);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
 
 /**
  * @title UserConfiguration library
@@ -4627,750 +4008,7 @@ library UserConfiguration {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/AaveV3Ethereum.sol
...
-}
-
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableAToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IInitializableAToken.sol
 
 /**
  * @title IInitializableAToken
@@ -5423,7 +4061,7 @@ interface IInitializableAToken {
   ) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableDebtToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IInitializableDebtToken.sol
 
 /**
  * @title IInitializableDebtToken
@@ -5472,7 +4110,7 @@ interface IInitializableDebtToken {
   ) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IStableDebtToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IStableDebtToken.sol
 
 /**
  * @title IStableDebtToken
@@ -5609,7 +4247,7 @@ interface IStableDebtToken is IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
 
 /**
  * @title IsolationModeLogic library
@@ -5668,7 +4306,7 @@ library IsolationModeLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IVariableDebtToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IVariableDebtToken.sol
 
 /**
  * @title IVariableDebtToken
@@ -5711,7 +4349,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IAToken.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/interfaces/IAToken.sol
 
 /**
  * @title IAToken
@@ -5845,7 +4483,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
   function rescueTokens(address token, address to, uint256 amount) external;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
 
 /**
  * @title IncentivizedERC20
@@ -6069,7 +4707,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -6429,7 +5067,7 @@ library ReserveLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/pool/PoolStorage.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/pool/PoolStorage.sol
 
 /**
  * @title PoolStorage
@@ -6475,7 +5113,7 @@ contract PoolStorage {
   uint16 internal _reservesCount;
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
 
 /**
  * @title EModeLogic library
@@ -6576,7 +5214,7 @@ library EModeLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
 
 /**
  * @title GenericLogic library
@@ -6834,7 +5472,7 @@ library GenericLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -7594,7 +6232,7 @@ library ValidationLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol
 
 library BridgeLogic {
   using ReserveLogic for DataTypes.ReserveCache;
@@ -7731,7 +6369,7 @@ library BridgeLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/PoolLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/PoolLogic.sol
 
 /**
  * @title PoolLogic library
@@ -7921,7 +6559,7 @@ library PoolLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/SupplyLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/SupplyLogic.sol
 
 /**
  * @title SupplyLogic library
@@ -8209,7 +6847,7 @@ library SupplyLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/BorrowLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/BorrowLogic.sol
 
 /**
  * @title BorrowLogic library
@@ -8553,7 +7191,7 @@ library BorrowLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol
 
 /**
  * @title LiquidationLogic library
@@ -9063,7 +7701,7 @@ library LiquidationLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol
 
 /**
  * @title FlashLoanLogic library
@@ -9329,7 +7967,7 @@ library FlashLoanLogic {
   }
 }
 
-// downloads/GNOSIS/POOL_IMPL/PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/pool/Pool.sol
+// downloads/ZKSYNC/POOL_IMPL/PoolInstance/src/core/contracts/protocol/pool/Pool.sol
 
 /**
  * @title Pool contract
@@ -10159,7 +8797,7 @@ abstract contract Pool is VersionedInitializable, PoolStorage, IPool {
   }
 }
