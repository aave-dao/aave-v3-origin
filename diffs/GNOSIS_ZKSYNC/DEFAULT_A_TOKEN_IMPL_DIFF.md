...
@@ -1027,13 +1076,14 @@ library DataTypes {
...
@@ -1168,6 +1218,7 @@ library DataTypes {
...
@@ -1232,7 +1283,8 @@ library DataTypes {
...
@@ -1246,7 +1298,7 @@ library DataTypes {
   }
 }
...
+// downloads/ZKSYNC/DEFAULT_A_TOKEN_IMPL/ATokenInstance/src/core/contracts/protocol/tokenization/base/EIP712Base.sol
 ...
 /**
  * @title EIP712Base
@@ -1316,7 +1368,7 @@ abstract contract EIP712Base {
...
@@ -1429,7 +1481,7 @@ library GPv2SafeERC20 {
   }
 }
...
@@ -1439,7 +1491,7 @@ interface IERC20Detailed is IERC20 {
...
+// downloads/ZKSYNC/DEFAULT_A_TOKEN_IMPL/ATokenInstance/src/core/contracts/interfaces/IACLManager.sol
 ...
 /**
  * @title IACLManager
@@ -1612,7 +1664,7 @@ interface IACLManager {
...
+// downloads/ZKSYNC/DEFAULT_A_TOKEN_IMPL/ATokenInstance/src/core/contracts/interfaces/IPool.sol
 ...
 /**
  * @title IPool
@@ -1990,6 +2042,14 @@ interface IPool {
    */
...
@@ -2134,6 +2194,22 @@ interface IPool {
...
+
    ...
    * @dev Only callable by the PoolConfigurator contract
@@ -2189,7 +2265,23 @@ interface IPool {
    * @param asset The address of the underlying asset of the reserve
...
@@ -2217,6 +2309,13 @@ interface IPool {
    */
...
@@ -2287,6 +2386,22 @@ interface IPool {
    */
...
@@ -2344,9 +2459,44 @@ interface IPool {
...
@@ -2399,7 +2549,7 @@ interface IInitializableAToken {
   ) external;
 }
...
+// downloads/ZKSYNC/DEFAULT_A_TOKEN_IMPL/ATokenInstance/src/core/contracts/interfaces/IAToken.sol
 ...
 /**
  * @title IAToken
@@ -2533,7 +2683,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
...
@@ -2819,7 +2969,7 @@ abstract contract MintableIncentivizedERC20 is IncentivizedERC20 {
   }
 }
...
@@ -2968,14 +3118,14 @@ abstract contract ScaledBalanceTokenBase is MintableIncentivizedERC20, IScaledBa
   }
 }
