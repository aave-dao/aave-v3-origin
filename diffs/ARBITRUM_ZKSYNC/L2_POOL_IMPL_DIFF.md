...
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/common/ICollector.sol
-
-/**
- * @title ICollector
...
-}
-
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Address.sol
 
 // OpenZeppelin Contracts v4.4.1 (utils/Address.sol)
 
@@ -408,7 +221,7 @@ library Address {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/Context.sol
 
 /*
  * @dev Provides information about the current execution context, including the
@@ -431,7 +244,7 @@ abstract contract Context {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IAccessControl.sol
 
 /**
  * @dev External interface of AccessControl declared to support ERC165 detection.
@@ -521,7 +334,7 @@ interface IAccessControl {
   function renounceRole(bytes32 role, address account) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20.sol
 
 /**
  * @dev Interface of the ERC20 standard as defined in the EIP.
@@ -597,7 +410,7 @@ interface IERC20 {
   event Approval(address indexed owner, address indexed spender, uint256 value);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/SafeCast.sol
 
 // OpenZeppelin Contracts v4.4.1 (utils/math/SafeCast.sol)
 
@@ -853,7 +666,7 @@ library SafeCast {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IAaveIncentivesController.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IAaveIncentivesController.sol
 
 /**
  * @title IAaveIncentivesController
@@ -872,7 +685,7 @@ interface IAaveIncentivesController {
   function handleAction(address user, uint256 totalSupply, uint256 userBalance) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IL2Pool.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IL2Pool.sol
 
 /**
  * @title IL2Pool
@@ -1006,7 +819,7 @@ interface IL2Pool {
   function liquidationCall(bytes32 args1, bytes32 args2) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPoolAddressesProvider.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IPoolAddressesProvider.sol
 
 /**
  * @title IPoolAddressesProvider
@@ -1233,7 +1046,7 @@ interface IPoolAddressesProvider {
   function setPoolDataProvider(address newDataProvider) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPriceOracleGetter.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IPriceOracleGetter.sol
 
 /**
  * @title IPriceOracleGetter
@@ -1263,7 +1076,7 @@ interface IPriceOracleGetter {
   function getAssetPrice(address asset) external view returns (uint256);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IScaledBalanceToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IScaledBalanceToken.sol
 
 /**
  * @title IScaledBalanceToken
@@ -1335,7 +1148,7 @@ interface IScaledBalanceToken {
   function getPreviousIndex(address user) external view returns (uint256);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/aave-upgradeability/VersionedInitializable.sol
 
 /**
  * @title VersionedInitializable
@@ -1412,7 +1225,7 @@ abstract contract VersionedInitializable {
   uint256[50] private ______gap;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/helpers/Errors.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/helpers/Errors.sol
 
 /**
  * @title Errors library
@@ -1520,7 +1333,7 @@ library Errors {
   string public constant INVALID_FREEZE_STATE = '99'; // Reserve is already in the passed freeze state
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/CalldataLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/CalldataLogic.sol
 
 /**
  * @title CalldataLogic library
@@ -1795,7 +1608,7 @@ library CalldataLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/PercentageMath.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/math/PercentageMath.sol
 
 /**
  * @title PercentageMath library
@@ -1856,7 +1669,7 @@ library PercentageMath {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/WadRayMath.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/math/WadRayMath.sol
 
 /**
  * @title WadRayMath library
@@ -1982,7 +1795,7 @@ library WadRayMath {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/types/DataTypes.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/types/DataTypes.sol
 
 library DataTypes {
   /**
@@ -2295,7 +2108,7 @@ library DataTypes {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/gnosis/contracts/GPv2SafeERC20.sol
 
 /// @title Gnosis Protocol v2 Safe ERC20 Transfer Library
 /// @author Gnosis Developers
@@ -2408,7 +2221,7 @@ library GPv2SafeERC20 {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/dependencies/openzeppelin/contracts/IERC20Detailed.sol
 
 interface IERC20Detailed is IERC20 {
   function name() external view returns (string memory);
@@ -2418,7 +2231,7 @@ interface IERC20Detailed is IERC20 {
   function decimals() external view returns (uint8);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IACLManager.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IACLManager.sol
 
 /**
  * @title IACLManager
@@ -2591,7 +2404,7 @@ interface IACLManager {
   function isAssetListingAdmin(address admin) external view returns (bool);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IERC20WithPermit.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IERC20WithPermit.sol
 
 /**
  * @title IERC20WithPermit
@@ -2622,7 +2435,7 @@ interface IERC20WithPermit is IERC20 {
   ) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPriceOracleSentinel.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IPriceOracleSentinel.sol
 
 /**
  * @title IPriceOracleSentinel
@@ -2687,7 +2500,7 @@ interface IPriceOracleSentinel {
   function getGracePeriod() external view returns (uint256);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IReserveInterestRateStrategy.sol
 
 /**
  * @title IReserveInterestRateStrategy
@@ -2715,7 +2528,7 @@ interface IReserveInterestRateStrategy {
   ) external view returns (uint256, uint256, uint256);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/math/MathUtils.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/math/MathUtils.sol
 
 /**
  * @title MathUtils library
@@ -2812,7 +2625,7 @@ library MathUtils {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IPool.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IPool.sol
 
 /**
  * @title IPool
@@ -3644,7 +3457,7 @@ interface IPool {
   function getSupplyLogic() external returns (address);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/configuration/ReserveConfiguration.sol
 
 /**
  * @title ReserveConfiguration library
@@ -4281,7 +4094,7 @@ library ReserveConfiguration {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/helpers/Helpers.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/helpers/Helpers.sol
 
 /**
  * @title Helpers library
@@ -4306,7 +4119,7 @@ library Helpers {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/flashloan/interfaces/IFlashLoanReceiver.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanReceiver.sol
 
 /**
  * @title IFlashLoanReceiver
@@ -4339,7 +4152,7 @@ interface IFlashLoanReceiver {
   function POOL() external view returns (IPool);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/flashloan/interfaces/IFlashLoanSimpleReceiver.sol
 
 /**
  * @title IFlashLoanSimpleReceiver
@@ -4372,7 +4185,7 @@ interface IFlashLoanSimpleReceiver {
   function POOL() external view returns (IPool);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/configuration/UserConfiguration.sol
 
 /**
  * @title UserConfiguration library
@@ -4604,7 +4417,7 @@ library UserConfiguration {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableAToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IInitializableAToken.sol
 
 /**
  * @title IInitializableAToken
@@ -4657,7 +4470,7 @@ interface IInitializableAToken {
   ) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IInitializableDebtToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IInitializableDebtToken.sol
 
 /**
  * @title IInitializableDebtToken
@@ -4706,7 +4519,7 @@ interface IInitializableDebtToken {
   ) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IStableDebtToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IStableDebtToken.sol
 
 /**
  * @title IStableDebtToken
@@ -4843,7 +4656,7 @@ interface IStableDebtToken is IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/IsolationModeLogic.sol
 
 /**
  * @title IsolationModeLogic library
@@ -4902,7 +4715,7 @@ library IsolationModeLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IVariableDebtToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IVariableDebtToken.sol
 
 /**
  * @title IVariableDebtToken
@@ -4945,7 +4758,7 @@ interface IVariableDebtToken is IScaledBalanceToken, IInitializableDebtToken {
   function UNDERLYING_ASSET_ADDRESS() external view returns (address);
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/interfaces/IAToken.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/interfaces/IAToken.sol
 
 /**
  * @title IAToken
@@ -5079,7 +4892,7 @@ interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
   function rescueTokens(address token, address to, uint256 amount) external;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/tokenization/base/IncentivizedERC20.sol
 
 /**
  * @title IncentivizedERC20
@@ -5303,766 +5116,7 @@ abstract contract IncentivizedERC20 is Context, IERC20Detailed {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/AaveV3.sol
-
...
-}
-
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-helpers/lib/aave-address-book/src/AaveV3Ethereum.sol
...
-}
-
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/ReserveLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -6422,7 +5476,7 @@ library ReserveLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/pool/PoolStorage.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/pool/PoolStorage.sol
 
 /**
  * @title PoolStorage
@@ -6468,7 +5522,7 @@ contract PoolStorage {
   uint16 internal _reservesCount;
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/EModeLogic.sol
 
 /**
  * @title EModeLogic library
@@ -6569,7 +5623,7 @@ library EModeLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/GenericLogic.sol
 
 /**
  * @title GenericLogic library
@@ -6827,7 +5881,7 @@ library GenericLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/ValidationLogic.sol
 
 /**
  * @title ReserveLogic library
@@ -7587,7 +6641,7 @@ library ValidationLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/BridgeLogic.sol
 
 library BridgeLogic {
   using ReserveLogic for DataTypes.ReserveCache;
@@ -7724,7 +6778,7 @@ library BridgeLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/PoolLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/PoolLogic.sol
 
 /**
  * @title PoolLogic library
@@ -7914,7 +6968,7 @@ library PoolLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/SupplyLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/SupplyLogic.sol
 
 /**
  * @title SupplyLogic library
@@ -8202,7 +7256,7 @@ library SupplyLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/BorrowLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/BorrowLogic.sol
 
 /**
  * @title BorrowLogic library
@@ -8546,7 +7600,7 @@ library BorrowLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/LiquidationLogic.sol
 
 /**
  * @title LiquidationLogic library
@@ -9056,7 +8110,7 @@ library LiquidationLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/libraries/logic/FlashLoanLogic.sol
 
 /**
  * @title FlashLoanLogic library
@@ -9322,7 +8376,7 @@ library FlashLoanLogic {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/pool/Pool.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/pool/Pool.sol
 
 /**
  * @title Pool contract
@@ -10152,7 +9206,7 @@ abstract contract Pool is VersionedInitializable, PoolStorage, IPool {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/instances/PoolInstance.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/instances/PoolInstance.sol
 
 contract PoolInstance is Pool {
   uint256 public constant POOL_REVISION = 4;
@@ -10176,7 +9230,7 @@ contract PoolInstance is Pool {
   }
 }
 
-// downloads/ARBITRUM/L2_POOL_IMPL/L2PoolInstanceWithCustomInitialize/lib/aave-v3-origin/src/core/contracts/protocol/pool/L2Pool.sol
+// downloads/ZKSYNC/L2_POOL_IMPL/L2PoolInstance/src/core/contracts/protocol/pool/L2Pool.sol
 
 /**
  * @title L2Pool
@@ -10291,79 +9345,8 @@ abstract contract L2Pool is Pool, IL2Pool {
   }
 }
