...
contract PoolEModeTests is TestnetProcedures {
  ...
  function test_setUserEmode(uint8 eMode) public {
    // create 2 emodes
    ...
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.wbtc, ct1.id, true);
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.weth, ct1.id, true);
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.wbtc, ct2.id, true);
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.usdx, ct2.id, true);
    vm.stopPrank();
  ...
  function test_setUserEmode_switchToBetterEModeShouldBePossible(uint104 amount) public {
    ...
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.usdx, 1, true);
    contracts.poolConfiguratorProxy.setAssetEModeCategory(tokenList.usdx, 2, true);
