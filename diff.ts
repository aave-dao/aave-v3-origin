...
const API_KEYS = {
  ...
  [Networks.SONIC]: process.env.ETHERSCAN_API_KEY_SONIC,
  [Networks.FACTORY_LOCAL]: undefined,
};

const RPC_URLS = {
  [Networks.GNOSIS]: process.env.RPC_GNOSIS,
  [Networks.SONIC]: process.env.RPC_SONIC,
  [Networks.FACTORY_LOCAL]: undefined,
};
...
function getImpl(network: Networks, address: string) {
  // as v3.3 proposal is not yet executed
  if (address == AaveV3Gnosis.POOL) return '0x77C874799E9564A0D0670ED40bf023D249E7bb21';
  if (address == AaveV3Gnosis.POOL_CONFIGURATOR) return '0xE5e48Ad1F9D1A894188b483DcF91f4FaD6AbA43b';
