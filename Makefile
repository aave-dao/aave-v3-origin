...
# List Mainnet Assets
list-assets :; forge script scripts/misc/ConfigureHorizonMainnet.sol:ConfigureHorizonMainnet --rpc-url ${CHAIN} --private-key ${PRIVATE_KEY} --sender ${SENDER} --slow --broadcast --gas-estimate-multiplier 150
